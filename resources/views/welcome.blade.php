...
Seeing the development of HOREKA's business in Indonesia, Catureka was built in 2015 specifically to serve the needs of the market with the maximum service and professional.</p>
								...
								<div class="wthree-bottom-grids">
									<div class="col-md-6 wthree-bottom-grid">
										<div  class="w3-agileits-bottom-left">
											...
											<div class="w3-agileits-bottom-left-text">
												<h3>Product</h3>
												<p>We provide the products you need to meet the needs of the kitchen, catering, restaurants, hotels, cafes, and even your business. With the best quality and price, we strive to be your best partner in developing the business.</p>
											</div>
											</a>
										</div>
									</div>
									<div class="col-md-6 wthree-bottom-grid gbg">
										<div  class="w3-agileits-bottom-left w3-agileits-bottom-right">
											<a href="#customkitchen">
											<div class="w3-agileits-bottom-left-text">
												<h3>Custom</h3>
												<p>We provide custom kitchen service for you. Specialized with the best quality stainless steel equipment. You can choose your own design, or ask us to design. We try to help realize your dream kitchen.</p>
											</div>
											</a>
										</div>
									</div>
	...
	<!-- custom -->
	<div id="customkitchen" style="background: url(../csa/kitchen/design9.jpg) no-repeat 0px 0px;" class="popular-section-wthree jarallax">
		<div class="agileinfo-dot">
				...
				<div style="max-width: 100%;" class="container">
				  <div id="myCarousel" class="carousel slide" data-ride="carousel">
				    ...
				    <div class="carousel-inner">
				      ...
				      <div class="item">
				        <img src="{{('csa/kitchen/design2.jpg')}}" alt="Custom Kitchen" style="width:100%;">
				        <div class="carousel-caption">
				          <h3>Custom Kitchen</h3>
				        ...
				        <div class="carousel-caption">
				          ...
				          <p>We try to help realize your dream kitchen.</p>
							...
							<div class="item">
				        <img src="{{('csa/kitchen/design1.jpg')}}" alt="Custom Kitchen" style="width:100%;">
				        <div class="carousel-caption">
									<h3>Custom Kitchen</h3>
								 	<p>We provide custom kitchen service for you.</p>
				        </div>
				        ...
				        <div class="carousel-caption">
				          ...
				          <p>You can choose your own design, or ask us to design.</p>
							...
							<div class="item">
				        <img src="{{('csa/kitchen/design7.jpg')}}" alt="Custom Kitchen" style="width:100%;">
				        <div class="carousel-caption">
									<h3>Custom Kitchen</h3>
				          <p>We try to help realize your dream kitchen.</p>
				        </div>
			...
			<div class="news-agileinfo">
				<div class="col-md-4 news-right agileits-w3layouts">
					...
					<div class="achievesw3-agile">
						<ul>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Lorem ipsum dolor sit amet.</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Donec tempor odio vitae.</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Phasellus gravida mi dui. </a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Sitid auctor donec neque.</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Lorem ipsum dolor sit amet.</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Donec tempor odio vitae.</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Phasellus gravida mi dui. </a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Sitid auctor donec neque.</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Donec neque sitid auctor.</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-8 news-w3row">
					<div class="wthree-news-grids">
						<div class="col-md-3 col-xs-3 datew3-agileits">
							<img src="{{url('csa/images/t1.jpg')}}" class="img-responsive" alt=""/>
						</div>
					...
					<div class="wthree-news-grids news-grids-mdl">
						<div class="col-md-3 col-xs-3 datew3-agileits datew3-agileits-fltrt">
							<img src="{{url('csa/images/t2.jpg')}}" class="img-responsive" alt=""/>
						</div>
					...
					<div class="wthree-news-grids">
						<div class="col-md-3 col-xs-3 datew3-agileits">
							<img src="{{url('csa/images/t3.jpg')}}" class="img-responsive" alt=""/>
						</div>
						<div class="col-md-9 col-xs-9 datew3-agileits-info ">
							<h5><a href="#" data-toggle="modal" data-target="#myModal">Fusce scelerisque sit amet justo vitae</a></h5>
							<h6>8/05/2017</h6>
...
<!-- bootstrap-pop-up -->
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<img src="{{url('csa/images/2.jpg')}}" alt=" " class="img-responsive" />
	...
	<div class="modal video-modal fade" id="myModalmutu" tabindex="-1" role="dialog" aria-labelledby="myModal">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					MUTU
